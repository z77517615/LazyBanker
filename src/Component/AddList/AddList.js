...
export default function AddList ({uid,passTransaction}){
    ...
    // function UpdateForm(document){
    //     setUpdateForm(document)
    // }
        ...
        <div className="transaction-list">
            ...
            <div className="addlist-container">
                ...
                <div className="addlist-container_button">
                    <button className="edit" onClick={() => passTransaction({...document,uuid:uuidv4()})}>Edit</button>
                    <button className="delete" onClick={() => deleteTransaction(document.id)}>Delet</button>
                </div>
            </div>
            </li>
            ))}
